...
@Component({
    selector: 'app-stats-import-popup',
    templateUrl: './stats-import-popup.component.html',
    styleUrls: ['./stats-import-popup.component.scss']
})
export class StatsImportPopupComponent{


    public userData: AppUser;

    constructor(private userService: UserService, @Inject(MAT_DIALOG_DATA) public set: GearSet,
                private ref: MatDialogRef<StatsImportPopupComponent>) {
